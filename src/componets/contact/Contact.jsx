        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            ...
            <div className="flex items-center gap-2 mt-auto">
              ...
              <form 
              action="https://getform.io/f/byvvpvna" 
              method="POST"
              ...
              <div className="mb-4">
               <label 
               htmlFor="message" 
               className="label mt-4 reveal-up">
                  Message
               </label>
               <textarea 
               placeholder="Enter your message"
               required
               className="text-field resize-y reveal-up"
               rows={6}
               name="message" 
               id="message"></textarea>
              </div>
              ...
              <button
              type="submit"
              className="btn border active:bg-orange-600 active:text-white border-orange-600 text-orange-600 mt-6 mb-10 reveal-up"
              >Send</button>
